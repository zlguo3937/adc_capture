...
filelist:
	...
	@python3.11 $(script_dir)/yml2list/gen_filelist.py $(BASE_DIR)/project.yml $(BASE_DIR)/builds/filelist/
...
yaml:
	...
	@python3.11 $(script_dir)/csv2yml/csv_2_yaml.py $(csv_dir)/top_regfile.csv $(base_dir)/builds/yaml/top_regfile.yml
	@python3.11 $(script_dir)/csv2yml/ana_csv2yaml.py $(csv_dir)/Dongting_Analog_Register_Map_R0P0.csv $(base_dir)/builds/yaml/Dongting_Analog_Register_Map_R0P0.yml
