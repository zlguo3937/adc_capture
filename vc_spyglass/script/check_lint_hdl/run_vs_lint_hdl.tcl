...
exec mkdir -p ${work}/${currentTime}_lint_hdl

set lint_hdl_path ${work}/${currentTime}_lint_hdl
...
define_design_lib WORK -path lint_hdl_path/VCS
...
checkpoint_session -session ${lint_hdl_path}/${TOP_MODULE}.lint_hdl_session
