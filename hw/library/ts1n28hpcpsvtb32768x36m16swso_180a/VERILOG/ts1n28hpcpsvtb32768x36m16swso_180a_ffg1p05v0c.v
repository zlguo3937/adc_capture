...
`ifdef UNIT_DELAY
parameter tSDQ = 2.1854;
parameter tSLPQ = 2.1854;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6178;
    specparam tCKH = 0.0775;
    specparam tCKL = 0.0927;
    specparam tCS = 0.0816;
    specparam tCH = 0.0603;
    specparam tWS = 0.0464;
    specparam tWH = 0.0623;
    specparam tAS = 0.0598;
    specparam tAH = 0.0636;
    specparam tDS = 0.0361;
    specparam tDH = 0.0633;
    specparam tCD = 0.6178;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6178;
`else    
    specparam tHOLD = 0.3959;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.6340;
    specparam tSDWK2CLK = 10.6340;
    specparam tSD = 0.6178;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9702;
    specparam tSDQ = 2.1854;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8195;
    specparam tSLPWK2CLK = 0.8195;
    specparam tSLP = 0.6178;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.9926;
    specparam tSLPQ = 2.1854;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0434;
    specparam tBWH = 0.0634;
