...
`ifdef UNIT_DELAY
parameter tSDQ = 2.3220;
parameter tSLPQ = 2.3220;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6582;
    specparam tCKH = 0.0829;
    specparam tCKL = 0.1000;
    specparam tCS = 0.0862;
    specparam tCH = 0.0632;
    specparam tWS = 0.0487;
    specparam tWH = 0.0653;
    specparam tAS = 0.0635;
    specparam tAH = 0.0666;
    specparam tDS = 0.0375;
    specparam tDH = 0.0665;
    specparam tCD = 0.6582;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6582;
`else    
    specparam tHOLD = 0.4286;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.0092;
    specparam tSDWK2CLK = 11.0092;
    specparam tSD = 0.6582;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9829;
    specparam tSDQ = 2.3220;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8708;
    specparam tSLPWK2CLK = 0.8708;
    specparam tSLP = 0.6582;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.0130;
    specparam tSLPQ = 2.3220;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0456;
    specparam tBWH = 0.0666;
