...
`ifdef UNIT_DELAY
parameter tSDQ = 4.1441;
parameter tSLPQ = 4.1441;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.1550;
    specparam tCKH = 0.1460;
    specparam tCKL = 0.1910;
    specparam tCS = 0.1418;
    specparam tCH = 0.0981;
    specparam tWS = 0.0795;
    specparam tWH = 0.1012;
    specparam tAS = 0.1125;
    specparam tAH = 0.1028;
    specparam tDS = 0.0592;
    specparam tDH = 0.1086;
    specparam tCD = 1.1550;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.1550;
`else    
    specparam tHOLD = 0.8352;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 15.6908;
    specparam tSDWK2CLK = 15.6908;
    specparam tSD = 1.1550;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.2776;
    specparam tSDQ = 4.1441;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.5540;
    specparam tSLPWK2CLK = 1.5540;
    specparam tSLP = 1.1550;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3625;
    specparam tSLPQ = 4.1441;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0717;
    specparam tBWH = 0.1087;
