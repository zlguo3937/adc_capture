...
`ifdef UNIT_DELAY
parameter tSDQ = 3.2646;
parameter tSLPQ = 3.2646;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9173;
    specparam tCKH = 0.1169;
    specparam tCKL = 0.1501;
    specparam tCS = 0.1155;
    specparam tCH = 0.0831;
    specparam tWS = 0.0666;
    specparam tWH = 0.0855;
    specparam tAS = 0.0913;
    specparam tAH = 0.0870;
    specparam tDS = 0.0497;
    specparam tDH = 0.0910;
    specparam tCD = 0.9173;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.9173;
`else    
    specparam tHOLD = 0.6455;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 13.5557;
    specparam tSDWK2CLK = 13.5557;
    specparam tSD = 0.9173;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.0761;
    specparam tSDQ = 3.2646;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2242;
    specparam tSLPWK2CLK = 1.2242;
    specparam tSLP = 0.9173;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.1331;
    specparam tSLPQ = 3.2646;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0594;
    specparam tBWH = 0.0907;
