...
`ifdef UNIT_DELAY
parameter tSDQ = 4.2320;
parameter tSLPQ = 4.2320;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.1717;
    specparam tCKH = 0.1484;
    specparam tCKL = 0.1968;
    specparam tCS = 0.1446;
    specparam tCH = 0.0999;
    specparam tWS = 0.0808;
    specparam tWH = 0.1028;
    specparam tAS = 0.1140;
    specparam tAH = 0.1046;
    specparam tDS = 0.0618;
    specparam tDH = 0.1108;
    specparam tCD = 1.1717;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.1717;
`else    
    specparam tHOLD = 0.8571;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 15.8332;
    specparam tSDWK2CLK = 15.8332;
    specparam tSD = 1.1717;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.2587;
    specparam tSDQ = 4.2320;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.5870;
    specparam tSLPWK2CLK = 1.5870;
    specparam tSLP = 1.1717;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3496;
    specparam tSLPQ = 4.2320;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0739;
    specparam tBWH = 0.1108;
