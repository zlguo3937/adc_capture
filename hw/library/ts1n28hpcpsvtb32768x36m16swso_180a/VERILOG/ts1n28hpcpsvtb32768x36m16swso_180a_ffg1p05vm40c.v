...
`ifdef UNIT_DELAY
parameter tSDQ = 2.3116;
parameter tSLPQ = 2.1052;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5963;
    specparam tCKH = 0.0760;
    specparam tCKL = 0.0916;
    specparam tCS = 0.0800;
    specparam tCH = 0.0594;
    specparam tWS = 0.0457;
    specparam tWH = 0.0614;
    specparam tAS = 0.0588;
    specparam tAH = 0.0626;
    specparam tDS = 0.0362;
    specparam tDH = 0.0622;
    specparam tCD = 0.5963;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5963;
`else    
    specparam tHOLD = 0.3859;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.3895;
    specparam tSDWK2CLK = 10.3895;
    specparam tSD = 0.5963;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.8426;
    specparam tSDQ = 2.3116;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7895;
    specparam tSLPWK2CLK = 0.7895;
    specparam tSLP = 0.5963;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.8656;
    specparam tSLPQ = 2.1052;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0432;
    specparam tBWH = 0.0623;
