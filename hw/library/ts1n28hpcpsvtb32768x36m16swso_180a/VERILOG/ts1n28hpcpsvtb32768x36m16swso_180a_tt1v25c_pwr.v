...
`ifdef UNIT_DELAY
parameter tSDQ = 2.5276;
parameter tSLPQ = 2.5276;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7117;
    specparam tCKH = 0.0903;
    specparam tCKL = 0.1106;
    specparam tCS = 0.0926;
    specparam tCH = 0.0679;
    specparam tWS = 0.0532;
    specparam tWH = 0.0701;
    specparam tAS = 0.0701;
    specparam tAH = 0.0715;
    specparam tDS = 0.0396;
    specparam tDH = 0.0726;
    specparam tCD = 0.7117;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.7117;
`else    
    specparam tHOLD = 0.4707;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.7226;
    specparam tSDWK2CLK = 11.7226;
    specparam tSD = 0.7117;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.0226;
    specparam tSDQ = 2.5276;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9479;
    specparam tSLPWK2CLK = 0.9479;
    specparam tSLP = 0.7117;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.0566;
    specparam tSLPQ = 2.5276;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0482;
    specparam tBWH = 0.0726;
