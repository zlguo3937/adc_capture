...
`ifdef UNIT_DELAY
parameter tSDQ = 2.6344;
parameter tSLPQ = 2.6344;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7303;
    specparam tCKH = 0.0914;
    specparam tCKL = 0.1109;
    specparam tCS = 0.0949;
    specparam tCH = 0.0691;
    specparam tWS = 0.0537;
    specparam tWH = 0.0714;
    specparam tAS = 0.0714;
    specparam tAH = 0.0728;
    specparam tDS = 0.0391;
    specparam tDH = 0.0735;
    specparam tCD = 0.7303;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.7303;
`else    
    specparam tHOLD = 0.4792;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.3352;
    specparam tSDWK2CLK = 12.3352;
    specparam tSD = 0.7303;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.1824;
    specparam tSDQ = 2.6344;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9879;
    specparam tSLPWK2CLK = 0.9879;
    specparam tSLP = 0.7303;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.2143;
    specparam tSLPQ = 2.6344;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0486;
    specparam tBWH = 0.0737;
