...
`ifdef UNIT_DELAY
parameter tSDQ = 3.9337;
parameter tSLPQ = 3.9337;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.0818;
    specparam tCKH = 0.1370;
    specparam tCKL = 0.1725;
    specparam tCS = 0.1348;
    specparam tCH = 0.0941;
    specparam tWS = 0.0748;
    specparam tWH = 0.0971;
    specparam tAS = 0.1067;
    specparam tAH = 0.0988;
    specparam tDS = 0.0546;
    specparam tDH = 0.1025;
    specparam tCD = 1.0818;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.0818;
`else    
    specparam tHOLD = 0.7632;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 16.7294;
    specparam tSDWK2CLK = 16.7294;
    specparam tSD = 1.0818;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.4700;
    specparam tSDQ = 3.9337;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.4751;
    specparam tSLPWK2CLK = 1.4751;
    specparam tSLP = 1.0818;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.5384;
    specparam tSLPQ = 3.9337;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0676;
    specparam tBWH = 0.1022;
