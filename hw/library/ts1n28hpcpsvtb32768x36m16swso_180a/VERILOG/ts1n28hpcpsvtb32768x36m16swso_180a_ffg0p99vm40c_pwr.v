...
`ifdef UNIT_DELAY
parameter tSDQ = 2.3079;
parameter tSLPQ = 2.2422;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6400;
    specparam tCKH = 0.0817;
    specparam tCKL = 0.0993;
    specparam tCS = 0.0847;
    specparam tCH = 0.0624;
    specparam tWS = 0.0481;
    specparam tWH = 0.0645;
    specparam tAS = 0.0625;
    specparam tAH = 0.0657;
    specparam tDS = 0.0376;
    specparam tDH = 0.0656;
    specparam tCD = 0.6400;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6400;
`else    
    specparam tHOLD = 0.4187;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.7755;
    specparam tSDWK2CLK = 10.7755;
    specparam tSD = 0.6400;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.8568;
    specparam tSDQ = 2.3079;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8408;
    specparam tSLPWK2CLK = 0.8408;
    specparam tSLP = 0.6400;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.8841;
    specparam tSLPQ = 2.2422;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0450;
    specparam tBWH = 0.0657;
