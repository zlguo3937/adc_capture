...
`ifdef UNIT_DELAY
parameter tSDQ = 2.9781;
parameter tSLPQ = 2.9781;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8326;
    specparam tCKH = 0.1053;
    specparam tCKL = 0.1285;
    specparam tCS = 0.1065;
    specparam tCH = 0.0763;
    specparam tWS = 0.0594;
    specparam tWH = 0.0788;
    specparam tAS = 0.0807;
    specparam tAH = 0.0803;
    specparam tDS = 0.0438;
    specparam tDH = 0.0810;
    specparam tCD = 0.8326;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8326;
`else    
    specparam tHOLD = 0.5588;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 13.5732;
    specparam tSDWK2CLK = 13.5732;
    specparam tSD = 0.8326;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.2349;
    specparam tSDQ = 2.9781;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.1168;
    specparam tSLPWK2CLK = 1.1168;
    specparam tSLP = 0.8326;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.2792;
    specparam tSLPQ = 2.9781;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0541;
    specparam tBWH = 0.0813;
