...
`ifdef UNIT_DELAY
parameter tSDQ = 2.9127;
parameter tSLPQ = 2.9127;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8260;
    specparam tCKH = 0.1045;
    specparam tCKL = 0.1307;
    specparam tCS = 0.1056;
    specparam tCH = 0.0757;
    specparam tWS = 0.0596;
    specparam tWH = 0.0781;
    specparam tAS = 0.0804;
    specparam tAH = 0.0795;
    specparam tDS = 0.0444;
    specparam tDH = 0.0809;
    specparam tCD = 0.8260;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8260;
`else    
    specparam tHOLD = 0.5615;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.7814;
    specparam tSDWK2CLK = 12.7814;
    specparam tSD = 0.8260;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.0858;
    specparam tSDQ = 2.9127;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0922;
    specparam tSLPWK2CLK = 1.0922;
    specparam tSLP = 0.8260;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1301;
    specparam tSLPQ = 2.9127;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0538;
    specparam tBWH = 0.0811;
