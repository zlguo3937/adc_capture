...
`ifdef UNIT_DELAY
parameter tSDQ = 3.3464;
parameter tSLPQ = 3.3464;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9184;
    specparam tCKH = 0.1164;
    specparam tCKL = 0.1444;
    specparam tCS = 0.1166;
    specparam tCH = 0.0832;
    specparam tWS = 0.0657;
    specparam tWH = 0.0859;
    specparam tAS = 0.0911;
    specparam tAH = 0.0875;
    specparam tDS = 0.0473;
    specparam tDH = 0.0898;
    specparam tCD = 0.9184;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.9184;
`else    
    specparam tHOLD = 0.6302;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 14.9142;
    specparam tSDWK2CLK = 14.9142;
    specparam tSD = 0.9184;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.3495;
    specparam tSDQ = 3.3464;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2549;
    specparam tSLPWK2CLK = 1.2549;
    specparam tSLP = 0.9184;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3986;
    specparam tSLPQ = 3.3464;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0587;
    specparam tBWH = 0.0898;
