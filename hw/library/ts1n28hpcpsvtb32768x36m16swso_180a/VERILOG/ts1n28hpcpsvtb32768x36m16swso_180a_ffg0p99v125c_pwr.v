...
`ifdef UNIT_DELAY
parameter tSDQ = 2.5651;
parameter tSLPQ = 2.5651;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7053;
    specparam tCKH = 0.0861;
    specparam tCKL = 0.1015;
    specparam tCS = 0.0913;
    specparam tCH = 0.0659;
    specparam tWS = 0.0497;
    specparam tWH = 0.0681;
    specparam tAS = 0.0662;
    specparam tAH = 0.0695;
    specparam tDS = 0.0376;
    specparam tDH = 0.0680;
    specparam tCD = 0.7053;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.7053;
`else    
    specparam tHOLD = 0.4503;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.2355;
    specparam tSDWK2CLK = 12.2355;
    specparam tSD = 0.7053;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.3198;
    specparam tSDQ = 2.5651;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9619;
    specparam tSLPWK2CLK = 0.9619;
    specparam tSLP = 0.7053;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.3435;
    specparam tSLPQ = 2.5651;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0464;
    specparam tBWH = 0.0682;
