...
`ifdef UNIT_DELAY
parameter tSDQ = 2.4554;
parameter tSLPQ = 2.4554;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6714;
    specparam tCKH = 0.0817;
    specparam tCKL = 0.0957;
    specparam tCS = 0.0876;
    specparam tCH = 0.0635;
    specparam tWS = 0.0478;
    specparam tWH = 0.0657;
    specparam tAS = 0.0630;
    specparam tAH = 0.0671;
    specparam tDS = 0.0368;
    specparam tDH = 0.0654;
    specparam tCD = 0.6714;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6714;
`else    
    specparam tHOLD = 0.4243;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.8919;
    specparam tSDWK2CLK = 11.8919;
    specparam tSD = 0.6714;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.3058;
    specparam tSDQ = 2.4554;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9208;
    specparam tSLPWK2CLK = 0.9208;
    specparam tSLP = 0.6714;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.3351;
    specparam tSLPQ = 2.4554;
    specparam tSLPQH = 0.0000;

    specparam tBWS = 0.0447;
    specparam tBWH = 0.0659;
