...
`ifdef UNIT_DELAY
parameter tSDQ = 3.5004;
parameter tSLPQ = 3.3253;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9311;
    specparam tCKH = 0.1641;
    specparam tCKL = 0.1990;
    specparam tCS = 0.1519;
    specparam tCH = 0.1004;
    specparam tWS = 0.0865;
    specparam tWH = 0.1037;
    specparam tAS = 0.1201;
    specparam tAH = 0.1055;
    specparam tDS = 0.0753;
    specparam tDH = 0.1158;
    specparam tCD = 0.9175;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.9175;
`else    
    specparam tHOLD = 0.6390;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.0319;
    specparam tSDWK2CLK = 12.0319;
    specparam tSD = 0.9311;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.2974;
    specparam tSDQ = 3.5004;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2470;
    specparam tSLPWK2CLK = 1.2470;
    specparam tSLP = 0.9311;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3585;
    specparam tSLPQ = 3.3253;
