...
`ifdef UNIT_DELAY
parameter tSDQ = 4.0865;
parameter tSLPQ = 3.6072;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8233;
    specparam tCKH = 0.1412;
    specparam tCKL = 0.1677;
    specparam tCS = 0.1344;
    specparam tCH = 0.0907;
    specparam tWS = 0.0744;
    specparam tWH = 0.0938;
    specparam tAS = 0.1018;
    specparam tAH = 0.0955;
    specparam tDS = 0.0628;
    specparam tDH = 0.1011;
    specparam tCD = 0.8118;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8118;
`else    
    specparam tHOLD = 0.5372;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.0382;
    specparam tSDWK2CLK = 11.0382;
    specparam tSD = 0.8233;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.2771;
    specparam tSDQ = 4.0865;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.1026;
    specparam tSLPWK2CLK = 1.1026;
    specparam tSLP = 0.8233;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.3207;
    specparam tSLPQ = 3.6072;
