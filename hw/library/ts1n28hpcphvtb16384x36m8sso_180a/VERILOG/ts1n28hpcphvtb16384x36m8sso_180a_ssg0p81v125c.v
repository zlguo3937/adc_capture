...
`ifdef UNIT_DELAY
parameter tSDQ = 3.9361;
parameter tSLPQ = 3.9361;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.1021;
    specparam tCKH = 0.1923;
    specparam tCKL = 0.2308;
    specparam tCS = 0.1774;
    specparam tCH = 0.1152;
    specparam tWS = 0.0977;
    specparam tWH = 0.1193;
    specparam tAS = 0.1398;
    specparam tAH = 0.1213;
    specparam tDS = 0.0836;
    specparam tDH = 0.1295;
    specparam tCD = 1.0809;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.0809;
`else    
    specparam tHOLD = 0.7481;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 14.9159;
    specparam tSDWK2CLK = 14.9159;
    specparam tSD = 1.1021;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.7487;
    specparam tSDQ = 3.9361;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.4761;
    specparam tSLPWK2CLK = 1.4761;
    specparam tSLP = 1.1021;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.8049;
    specparam tSLPQ = 3.9361;
