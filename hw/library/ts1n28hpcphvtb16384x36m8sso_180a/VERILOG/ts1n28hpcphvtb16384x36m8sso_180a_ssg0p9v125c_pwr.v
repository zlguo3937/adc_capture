...
`ifdef UNIT_DELAY
parameter tSDQ = 3.2315;
parameter tSLPQ = 3.2315;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9048;
    specparam tCKH = 0.1569;
    specparam tCKL = 0.1851;
    specparam tCS = 0.1455;
    specparam tCH = 0.0994;
    specparam tWS = 0.0817;
    specparam tWH = 0.1027;
    specparam tAS = 0.1137;
    specparam tAH = 0.1045;
    specparam tDS = 0.0686;
    specparam tDH = 0.1099;
    specparam tCD = 0.8868;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8868;
`else    
    specparam tHOLD = 0.5926;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.9394;
    specparam tSDWK2CLK = 12.9394;
    specparam tSD = 0.9048;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.5279;
    specparam tSDQ = 3.2315;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2118;
    specparam tSLPWK2CLK = 1.2118;
    specparam tSLP = 0.9048;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.5713;
    specparam tSLPQ = 3.2315;
