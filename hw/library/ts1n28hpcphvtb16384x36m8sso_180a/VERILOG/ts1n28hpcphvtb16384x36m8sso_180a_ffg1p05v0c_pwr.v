...
`ifdef UNIT_DELAY
parameter tSDQ = 4.0138;
parameter tSLPQ = 3.5340;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5997;
    specparam tCKH = 0.0975;
    specparam tCKL = 0.1134;
    specparam tCS = 0.0977;
    specparam tCH = 0.0695;
    specparam tWS = 0.0545;
    specparam tWH = 0.0720;
    specparam tAS = 0.0706;
    specparam tAH = 0.0734;
    specparam tDS = 0.0475;
    specparam tDH = 0.0753;
    specparam tCD = 0.5802;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5802;
`else    
    specparam tHOLD = 0.3570;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.2122;
    specparam tSDWK2CLK = 9.2122;
    specparam tSD = 0.5997;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.0559;
    specparam tSDQ = 4.0138;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8031;
    specparam tSLPWK2CLK = 0.8031;
    specparam tSLP = 0.5997;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.0784;
    specparam tSLPQ = 3.5340;
