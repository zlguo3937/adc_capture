...
`ifdef UNIT_DELAY
parameter tSDQ = 4.9564;
parameter tSLPQ = 4.2945;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9270;
    specparam tCKH = 0.1635;
    specparam tCKL = 0.1964;
    specparam tCS = 0.1508;
    specparam tCH = 0.1003;
    specparam tWS = 0.0854;
    specparam tWH = 0.1038;
    specparam tAS = 0.1190;
    specparam tAH = 0.1055;
    specparam tDS = 0.0737;
    specparam tDH = 0.1150;
    specparam tCD = 0.9155;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.9155;
`else    
    specparam tHOLD = 0.6321;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.0325;
    specparam tSDWK2CLK = 12.0325;
    specparam tSD = 0.9270;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.3344;
    specparam tSDQ = 4.9564;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2415;
    specparam tSLPWK2CLK = 1.2415;
    specparam tSLP = 0.9270;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.4005;
    specparam tSLPQ = 4.2945;
