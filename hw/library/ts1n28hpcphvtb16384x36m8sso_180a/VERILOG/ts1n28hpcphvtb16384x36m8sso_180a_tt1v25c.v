...
`ifdef UNIT_DELAY
parameter tSDQ = 4.1558;
parameter tSLPQ = 3.6758;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6961;
    specparam tCKH = 0.1171;
    specparam tCKL = 0.1373;
    specparam tCS = 0.1132;
    specparam tCH = 0.0799;
    specparam tWS = 0.0637;
    specparam tWH = 0.0827;
    specparam tAS = 0.0848;
    specparam tAH = 0.0842;
    specparam tDS = 0.0544;
    specparam tDH = 0.0872;
    specparam tCD = 0.6776;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6776;
`else    
    specparam tHOLD = 0.4345;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.9820;
    specparam tSDWK2CLK = 9.9820;
    specparam tSD = 0.6961;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.1418;
    specparam tSDQ = 4.1558;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9323;
    specparam tSLPWK2CLK = 0.9323;
    specparam tSLP = 0.6961;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1697;
    specparam tSLPQ = 3.6758;
