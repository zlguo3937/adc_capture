...
`ifdef UNIT_DELAY
parameter tSDQ = 2.4234;
parameter tSLPQ = 2.4234;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6786;
    specparam tCKH = 0.1078;
    specparam tCKL = 0.1226;
    specparam tCS = 0.1067;
    specparam tCH = 0.0756;
    specparam tWS = 0.0580;
    specparam tWH = 0.0784;
    specparam tAS = 0.0770;
    specparam tAH = 0.0799;
    specparam tDS = 0.0498;
    specparam tDH = 0.0808;
    specparam tCD = 0.6498;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6498;
`else    
    specparam tHOLD = 0.3940;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.3575;
    specparam tSDWK2CLK = 10.3575;
    specparam tSD = 0.6786;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.3876;
    specparam tSDQ = 2.4234;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9088;
    specparam tSLPWK2CLK = 0.9088;
    specparam tSLP = 0.6786;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.4040;
    specparam tSLPQ = 2.4234;
