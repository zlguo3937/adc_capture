...
`ifdef UNIT_DELAY
parameter tSDQ = 3.9659;
parameter tSLPQ = 3.4947;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6446;
    specparam tCKH = 0.1061;
    specparam tCKL = 0.1243;
    specparam tCS = 0.1051;
    specparam tCH = 0.0737;
    specparam tWS = 0.0581;
    specparam tWH = 0.0763;
    specparam tAS = 0.0763;
    specparam tAH = 0.0778;
    specparam tDS = 0.0506;
    specparam tDH = 0.0801;
    specparam tCD = 0.6281;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6281;
`else    
    specparam tHOLD = 0.3933;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.5878;
    specparam tSDWK2CLK = 9.5878;
    specparam tSD = 0.6446;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.0922;
    specparam tSDQ = 3.9659;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8634;
    specparam tSLPWK2CLK = 0.8634;
    specparam tSLP = 0.6446;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.1135;
    specparam tSLPQ = 3.4947;
