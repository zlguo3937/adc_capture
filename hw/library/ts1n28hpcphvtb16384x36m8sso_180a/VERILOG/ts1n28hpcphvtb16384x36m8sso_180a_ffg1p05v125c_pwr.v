...
`ifdef UNIT_DELAY
parameter tSDQ = 3.1495;
parameter tSLPQ = 2.7812;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6437;
    specparam tCKH = 0.1005;
    specparam tCKL = 0.1137;
    specparam tCS = 0.1008;
    specparam tCH = 0.0723;
    specparam tWS = 0.0550;
    specparam tWH = 0.0749;
    specparam tAS = 0.0724;
    specparam tAH = 0.0764;
    specparam tDS = 0.0475;
    specparam tDH = 0.0766;
    specparam tCD = 0.6124;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6124;
`else    
    specparam tHOLD = 0.3660;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.0308;
    specparam tSDWK2CLK = 10.0308;
    specparam tSD = 0.6437;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.3700;
    specparam tSDQ = 3.1495;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8621;
    specparam tSLPWK2CLK = 0.8621;
    specparam tSLP = 0.6437;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.3803;
    specparam tSLPQ = 2.7812;
