...
`ifdef UNIT_DELAY
parameter tSDQ = 4.3764;
parameter tSLPQ = 3.8523;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8189;
    specparam tCKH = 0.1392;
    specparam tCKL = 0.1638;
    specparam tCS = 0.1325;
    specparam tCH = 0.0907;
    specparam tWS = 0.0729;
    specparam tWH = 0.0938;
    specparam tAS = 0.1002;
    specparam tAH = 0.0955;
    specparam tDS = 0.0611;
    specparam tDH = 0.0997;
    specparam tCD = 0.8037;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8037;
`else    
    specparam tHOLD = 0.5237;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.6503;
    specparam tSDWK2CLK = 11.6503;
    specparam tSD = 0.8189;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.3854;
    specparam tSDQ = 4.3764;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0967;
    specparam tSLPWK2CLK = 1.0967;
    specparam tSLP = 0.8189;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.4224;
    specparam tSLPQ = 3.8523;
