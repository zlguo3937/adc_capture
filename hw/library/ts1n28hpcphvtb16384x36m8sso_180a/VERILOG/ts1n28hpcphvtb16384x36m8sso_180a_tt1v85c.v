...
`ifdef UNIT_DELAY
parameter tSDQ = 3.9879;
parameter tSLPQ = 3.5157;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7103;
    specparam tCKH = 0.1178;
    specparam tCKL = 0.1368;
    specparam tCS = 0.1143;
    specparam tCH = 0.0806;
    specparam tWS = 0.0636;
    specparam tWH = 0.0833;
    specparam tAS = 0.0853;
    specparam tAH = 0.0848;
    specparam tDS = 0.0540;
    specparam tDH = 0.0873;
    specparam tCD = 0.6870;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6870;
`else    
    specparam tHOLD = 0.4338;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.5940;
    specparam tSDWK2CLK = 10.5940;
    specparam tSD = 0.7103;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.2858;
    specparam tSDQ = 3.9879;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9513;
    specparam tSLPWK2CLK = 0.9513;
    specparam tSLP = 0.7103;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.3095;
    specparam tSLPQ = 3.5157;
