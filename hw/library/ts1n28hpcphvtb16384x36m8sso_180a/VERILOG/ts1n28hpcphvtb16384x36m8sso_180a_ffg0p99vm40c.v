...
`ifdef UNIT_DELAY
parameter tSDQ = 3.9429;
parameter tSLPQ = 3.4867;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6339;
    specparam tCKH = 0.1048;
    specparam tCKL = 0.1238;
    specparam tCS = 0.1040;
    specparam tCH = 0.0730;
    specparam tWS = 0.0580;
    specparam tWH = 0.0755;
    specparam tAS = 0.0758;
    specparam tAH = 0.0768;
    specparam tDS = 0.0502;
    specparam tDH = 0.0797;
    specparam tCD = 0.6168;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6168;
`else    
    specparam tHOLD = 0.3903;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.4237;
    specparam tSDWK2CLK = 9.4237;
    specparam tSD = 0.6339;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9800;
    specparam tSDQ = 3.9429;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8490;
    specparam tSLPWK2CLK = 0.8490;
    specparam tSLP = 0.6339;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.0067;
    specparam tSLPQ = 3.4867;
