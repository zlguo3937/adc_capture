...
`ifdef UNIT_DELAY
parameter tSDQ = 4.0172;
parameter tSLPQ = 3.5356;
`else
...
specify
    ...
    specparam tCKH = 0.0956;
    specparam tCKL = 0.1124;
    specparam tCS = 0.0962;
    specparam tCH = 0.0686;
    specparam tWS = 0.0541;
    specparam tWH = 0.0710;
    specparam tAS = 0.0698;
    specparam tAH = 0.0723;
    specparam tDS = 0.0473;
    specparam tDH = 0.0746;
    specparam tCD = 0.5654;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5654;
`else    
    specparam tHOLD = 0.3522;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.0518;
    specparam tSDWK2CLK = 9.0518;
    specparam tSD = 0.5848;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9410;
    specparam tSDQ = 4.0172;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7833;
    specparam tSLPWK2CLK = 0.7833;
    specparam tSLP = 0.5848;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.9567;
    specparam tSLPQ = 3.5356;
