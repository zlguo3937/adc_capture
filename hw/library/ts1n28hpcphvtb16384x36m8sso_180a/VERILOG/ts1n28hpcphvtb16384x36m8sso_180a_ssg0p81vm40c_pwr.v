...
`ifdef UNIT_DELAY
parameter tSDQ = 4.7270;
parameter tSLPQ = 4.7270;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.3236;
    specparam tCKH = 0.2228;
    specparam tCKL = 0.2776;
    specparam tCS = 0.2101;
    specparam tCH = 0.1268;
    specparam tWS = 0.1140;
    specparam tWH = 0.1308;
    specparam tAS = 0.1653;
    specparam tAH = 0.1330;
    specparam tDS = 0.1041;
    specparam tDH = 0.1481;
    specparam tCD = 1.2449;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.2449;
`else    
    specparam tHOLD = 0.9089;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 14.7248;
    specparam tSDWK2CLK = 14.7248;
    specparam tSD = 1.3236;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.8205;
    specparam tSDQ = 4.7270;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.7726;
    specparam tSLPWK2CLK = 1.7726;
    specparam tSLP = 1.3236;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.9231;
    specparam tSLPQ = 4.7270;
