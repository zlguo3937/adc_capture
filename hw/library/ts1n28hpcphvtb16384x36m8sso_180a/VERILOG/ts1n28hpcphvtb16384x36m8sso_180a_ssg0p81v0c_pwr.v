...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB16384X36M8SSO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB16384X36M8SSO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 4.4783;
parameter tSLPQ = 4.4783;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.2539;
    specparam tCKH = 0.2149;
    specparam tCKL = 0.2648;
    specparam tCS = 0.2006;
    specparam tCH = 0.1239;
    specparam tWS = 0.1098;
    specparam tWH = 0.1280;
    specparam tAS = 0.1586;
    specparam tAH = 0.1302;
    specparam tDS = 0.0979;
    specparam tDH = 0.1434;
    specparam tCD = 1.2033;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.2033;
`else    
    specparam tHOLD = 0.8666;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 14.4606;
    specparam tSDWK2CLK = 14.4606;
    specparam tSD = 1.2539;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.7660;
    specparam tSDQ = 4.4783;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.6793;
    specparam tSLPWK2CLK = 1.6793;
    specparam tSLP = 1.2539;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.8698;
    specparam tSLPQ = 4.4783;
