...
`ifdef UNIT_DELAY
parameter tSDQ = 4.9059;
parameter tSLPQ = 4.3417;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6886;
    specparam tCKH = 0.1149;
    specparam tCKL = 0.1374;
    specparam tCS = 0.1129;
    specparam tCH = 0.0788;
    specparam tWS = 0.0634;
    specparam tWH = 0.0815;
    specparam tAS = 0.0842;
    specparam tAH = 0.0830;
    specparam tDS = 0.0583;
    specparam tDH = 0.0769;
    specparam tCD = 0.6833;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6833;
`else    
    specparam tHOLD = 0.4412;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.1713;
    specparam tSDWK2CLK = 10.1713;
    specparam tSD = 0.6886;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.0314;
    specparam tSDQ = 4.9059;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9222;
    specparam tSLPWK2CLK = 0.9222;
    specparam tSLP = 0.6886;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.0520;
    specparam tSLPQ = 4.3417;
