...
`ifdef UNIT_DELAY
parameter tSDQ = 5.5154;
parameter tSLPQ = 4.4688;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5748;
    specparam tCKH = 0.0947;
    specparam tCKL = 0.1124;
    specparam tCS = 0.0961;
    specparam tCH = 0.0680;
    specparam tWS = 0.0538;
    specparam tWH = 0.0704;
    specparam tAS = 0.0692;
    specparam tAH = 0.0717;
    specparam tDS = 0.0501;
    specparam tDH = 0.0658;
    specparam tCD = 0.5677;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5677;
`else    
    specparam tHOLD = 0.3567;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.0570;
    specparam tSDWK2CLK = 9.0570;
    specparam tSD = 0.5748;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.8432;
    specparam tSDQ = 5.5154;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7699;
    specparam tSLPWK2CLK = 0.7699;
    specparam tSLP = 0.5748;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.8565;
    specparam tSLPQ = 4.4688;
