...
`ifdef UNIT_DELAY
parameter tSDQ = 3.3368;
parameter tSLPQ = 3.3368;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9343;
    specparam tCKH = 0.1590;
    specparam tCKL = 0.1996;
    specparam tCS = 0.1517;
    specparam tCH = 0.0990;
    specparam tWS = 0.0863;
    specparam tWH = 0.1022;
    specparam tAS = 0.1193;
    specparam tAH = 0.1040;
    specparam tDS = 0.0827;
    specparam tDH = 0.1038;
    specparam tCD = 0.9282;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.9282;
`else    
    specparam tHOLD = 0.6530;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.0339;
    specparam tSDWK2CLK = 12.0339;
    specparam tSD = 0.9343;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.1498;
    specparam tSDQ = 3.3368;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2513;
    specparam tSLPWK2CLK = 1.2513;
    specparam tSLP = 0.9343;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.2004;
    specparam tSLPQ = 3.3368;
