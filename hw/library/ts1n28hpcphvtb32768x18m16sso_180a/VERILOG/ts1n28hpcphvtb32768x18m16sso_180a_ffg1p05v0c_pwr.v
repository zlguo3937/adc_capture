...
`ifdef UNIT_DELAY
parameter tSDQ = 5.0615;
parameter tSLPQ = 4.6066;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5905;
    specparam tCKH = 0.0968;
    specparam tCKL = 0.1135;
    specparam tCS = 0.0977;
    specparam tCH = 0.0690;
    specparam tWS = 0.0542;
    specparam tWH = 0.0714;
    specparam tAS = 0.0701;
    specparam tAH = 0.0728;
    specparam tDS = 0.0503;
    specparam tDH = 0.0661;
    specparam tCD = 0.5824;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5824;
`else    
    specparam tHOLD = 0.3624;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.2220;
    specparam tSDWK2CLK = 9.2220;
    specparam tSD = 0.5905;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9612;
    specparam tSDQ = 5.0615;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7909;
    specparam tSLPWK2CLK = 0.7909;
    specparam tSLP = 0.5905;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.9733;
    specparam tSLPQ = 4.6066;
