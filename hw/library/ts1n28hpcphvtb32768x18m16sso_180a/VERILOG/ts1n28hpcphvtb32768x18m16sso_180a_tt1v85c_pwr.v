...
`ifdef UNIT_DELAY
parameter tSDQ = 4.3280;
parameter tSLPQ = 3.8248;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7052;
    specparam tCKH = 0.1157;
    specparam tCKL = 0.1370;
    specparam tCS = 0.1139;
    specparam tCH = 0.0796;
    specparam tWS = 0.0634;
    specparam tWH = 0.0824;
    specparam tAS = 0.0847;
    specparam tAH = 0.0839;
    specparam tDS = 0.0581;
    specparam tDH = 0.0762;
    specparam tCD = 0.6914;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6914;
`else    
    specparam tHOLD = 0.4400;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.8138;
    specparam tSDWK2CLK = 10.8138;
    specparam tSD = 0.7052;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.1761;
    specparam tSDQ = 4.3280;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9445;
    specparam tSLPWK2CLK = 0.9445;
    specparam tSLP = 0.7052;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1932;
    specparam tSLPQ = 3.8248;
