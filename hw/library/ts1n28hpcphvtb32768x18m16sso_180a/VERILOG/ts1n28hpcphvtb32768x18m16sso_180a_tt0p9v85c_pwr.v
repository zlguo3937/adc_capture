...
`ifdef UNIT_DELAY
parameter tSDQ = 2.9072;
parameter tSLPQ = 2.9072;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8140;
    specparam tCKH = 0.1369;
    specparam tCKL = 0.1642;
    specparam tCS = 0.1326;
    specparam tCH = 0.0895;
    specparam tWS = 0.0727;
    specparam tWH = 0.0925;
    specparam tAS = 0.0994;
    specparam tAH = 0.0942;
    specparam tDS = 0.0665;
    specparam tDH = 0.0873;
    specparam tCD = 0.8101;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8101;
`else    
    specparam tHOLD = 0.5324;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.8872;
    specparam tSDWK2CLK = 11.8872;
    specparam tSD = 0.8140;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.2633;
    specparam tSDQ = 2.9072;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0902;
    specparam tSLPWK2CLK = 1.0902;
    specparam tSLP = 0.8140;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.2939;
    specparam tSLPQ = 2.9072;
