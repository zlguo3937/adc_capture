...
`ifdef UNIT_DELAY
parameter tSDQ = 2.2843;
parameter tSLPQ = 2.2843;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6396;
    specparam tCKH = 0.0994;
    specparam tCKL = 0.1139;
    specparam tCS = 0.1009;
    specparam tCH = 0.0716;
    specparam tWS = 0.0546;
    specparam tWH = 0.0741;
    specparam tAS = 0.0720;
    specparam tAH = 0.0756;
    specparam tDS = 0.0499;
    specparam tDH = 0.0665;
    specparam tCD = 0.6141;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6141;
`else    
    specparam tHOLD = 0.3698;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.0313;
    specparam tSDWK2CLK = 10.0313;
    specparam tSD = 0.6396;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.2731;
    specparam tSDQ = 2.2843;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8566;
    specparam tSLPWK2CLK = 0.8566;
    specparam tSLP = 0.6396;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.2924;
    specparam tSLPQ = 2.2843;
