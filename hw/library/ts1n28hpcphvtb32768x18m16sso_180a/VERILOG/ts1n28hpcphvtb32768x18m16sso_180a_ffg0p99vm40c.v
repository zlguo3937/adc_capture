...
`ifdef UNIT_DELAY
parameter tSDQ = 5.3245;
parameter tSLPQ = 4.3939;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6224;
    specparam tCKH = 0.1038;
    specparam tCKL = 0.1241;
    specparam tCS = 0.1041;
    specparam tCH = 0.0722;
    specparam tWS = 0.0577;
    specparam tWH = 0.0746;
    specparam tAS = 0.0753;
    specparam tAH = 0.0760;
    specparam tDS = 0.0536;
    specparam tDH = 0.0706;
    specparam tCD = 0.6200;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6200;
`else    
    specparam tHOLD = 0.3957;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.4222;
    specparam tSDWK2CLK = 9.4222;
    specparam tSD = 0.6224;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.8717;
    specparam tSDQ = 5.3245;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8335;
    specparam tSLPWK2CLK = 0.8335;
    specparam tSLP = 0.6224;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.8927;
    specparam tSLPQ = 4.3939;
