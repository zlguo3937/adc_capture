...
`ifdef UNIT_DELAY
parameter tSDQ = 3.2302;
parameter tSLPQ = 3.2302;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9045;
    specparam tCKH = 0.1523;
    specparam tCKL = 0.1854;
    specparam tCS = 0.1455;
    specparam tCH = 0.0984;
    specparam tWS = 0.0813;
    specparam tWH = 0.1016;
    specparam tAS = 0.1127;
    specparam tAH = 0.1034;
    specparam tDS = 0.0751;
    specparam tDH = 0.0970;
    specparam tCD = 0.8958;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8958;
`else    
    specparam tHOLD = 0.6040;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.9719;
    specparam tSDWK2CLK = 12.9719;
    specparam tSD = 0.9045;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.3955;
    specparam tSDQ = 3.2302;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2113;
    specparam tSLPWK2CLK = 1.2113;
    specparam tSLP = 0.9045;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.4355;
    specparam tSLPQ = 3.2302;
