...
`ifdef UNIT_DELAY
parameter tSDQ = 4.2977;
parameter tSLPQ = 3.7833;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8193;
    specparam tCKH = 0.1386;
    specparam tCKL = 0.1680;
    specparam tCS = 0.1341;
    specparam tCH = 0.0897;
    specparam tWS = 0.0741;
    specparam tWH = 0.0928;
    specparam tAS = 0.1010;
    specparam tAH = 0.0944;
    specparam tDS = 0.0685;
    specparam tDH = 0.0893;
    specparam tCD = 0.8189;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8189;
`else    
    specparam tHOLD = 0.5473;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.2716;
    specparam tSDWK2CLK = 11.2716;
    specparam tSD = 0.8193;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.1525;
    specparam tSDQ = 4.2977;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0973;
    specparam tSLPWK2CLK = 1.0973;
    specparam tSLP = 0.8193;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1799;
    specparam tSLPQ = 3.7833;
