...
`ifdef UNIT_DELAY
parameter tSDQ = 3.3200;
parameter tSLPQ = 3.3200;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9296;
    specparam tCKH = 0.1584;
    specparam tCKL = 0.1968;
    specparam tCS = 0.1507;
    specparam tCH = 0.0991;
    specparam tWS = 0.0855;
    specparam tWH = 0.1024;
    specparam tAS = 0.1181;
    specparam tAH = 0.1041;
    specparam tDS = 0.0807;
    specparam tDH = 0.1029;
    specparam tCD = 0.9240;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.9240;
`else    
    specparam tHOLD = 0.6450;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.0382;
    specparam tSDWK2CLK = 12.0382;
    specparam tSD = 0.9296;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.2025;
    specparam tSDQ = 3.3200;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2450;
    specparam tSLPWK2CLK = 1.2450;
    specparam tSLP = 0.9296;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.2481;
    specparam tSLPQ = 3.3200;
