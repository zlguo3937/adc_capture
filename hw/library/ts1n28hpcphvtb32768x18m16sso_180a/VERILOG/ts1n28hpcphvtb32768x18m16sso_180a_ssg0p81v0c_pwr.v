...
`ifdef UNIT_DELAY
parameter tSDQ = 4.4966;
parameter tSLPQ = 4.4966;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.2590;
    specparam tCKH = 0.2093;
    specparam tCKL = 0.2654;
    specparam tCS = 0.1999;
    specparam tCH = 0.1222;
    specparam tWS = 0.1091;
    specparam tWH = 0.1261;
    specparam tAS = 0.1572;
    specparam tAH = 0.1283;
    specparam tDS = 0.1091;
    specparam tDH = 0.1282;
    specparam tCD = 1.2178;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.2178;
`else    
    specparam tHOLD = 0.8832;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 14.4571;
    specparam tSDWK2CLK = 14.4571;
    specparam tSD = 1.2590;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.6043;
    specparam tSDQ = 4.4966;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.6862;
    specparam tSLPWK2CLK = 1.6862;
    specparam tSLP = 1.2590;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.6616;
    specparam tSLPQ = 4.4966;
