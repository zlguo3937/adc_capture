...
`ifdef UNIT_DELAY
parameter tSDQ = 2.4063;
parameter tSLPQ = 2.4063;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6738;
    specparam tCKH = 0.1063;
    specparam tCKL = 0.1227;
    specparam tCS = 0.1066;
    specparam tCH = 0.0747;
    specparam tWS = 0.0576;
    specparam tWH = 0.0773;
    specparam tAS = 0.0765;
    specparam tAH = 0.0789;
    specparam tDS = 0.0524;
    specparam tDH = 0.0699;
    specparam tCD = 0.6525;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6525;
`else    
    specparam tHOLD = 0.3991;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.3638;
    specparam tSDWK2CLK = 10.3638;
    specparam tSD = 0.6738;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.2871;
    specparam tSDQ = 2.4063;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9024;
    specparam tSLPWK2CLK = 0.9024;
    specparam tSLP = 0.6738;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.3093;
    specparam tSLPQ = 2.4063;
