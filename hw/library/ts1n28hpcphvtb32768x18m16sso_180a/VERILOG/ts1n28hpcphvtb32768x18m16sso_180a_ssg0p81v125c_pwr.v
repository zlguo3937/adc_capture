...
`ifdef UNIT_DELAY
parameter tSDQ = 3.9393;
parameter tSLPQ = 3.9393;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.1030;
    specparam tCKH = 0.1885;
    specparam tCKL = 0.2305;
    specparam tCS = 0.1772;
    specparam tCH = 0.1140;
    specparam tWS = 0.0973;
    specparam tWH = 0.1179;
    specparam tAS = 0.1389;
    specparam tAH = 0.1198;
    specparam tDS = 0.0926;
    specparam tDH = 0.1143;
    specparam tCD = 1.0938;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.0938;
`else    
    specparam tHOLD = 0.7633;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 14.9269;
    specparam tSDWK2CLK = 14.9269;
    specparam tSD = 1.1030;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.5967;
    specparam tSDQ = 3.9393;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.4772;
    specparam tSLPWK2CLK = 1.4772;
    specparam tSLP = 1.1030;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.6439;
    specparam tSLPQ = 3.9393;
