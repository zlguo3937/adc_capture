...
`ifdef UNIT_DELAY
parameter tSDQ = 4.7224;
parameter tSLPQ = 4.7224;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.3223;
    specparam tCKH = 0.2165;
    specparam tCKL = 0.2782;
    specparam tCS = 0.2094;
    specparam tCH = 0.1253;
    specparam tWS = 0.1135;
    specparam tWH = 0.1292;
    specparam tAS = 0.1642;
    specparam tAH = 0.1315;
    specparam tDS = 0.1156;
    specparam tDH = 0.1330;
    specparam tCD = 1.2586;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.2586;
`else    
    specparam tHOLD = 0.9266;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 14.7545;
    specparam tSDWK2CLK = 14.7545;
    specparam tSD = 1.3223;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.6495;
    specparam tSDQ = 4.7224;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.7709;
    specparam tSLPWK2CLK = 1.7709;
    specparam tSLP = 1.3223;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.7100;
    specparam tSLPQ = 4.7224;
