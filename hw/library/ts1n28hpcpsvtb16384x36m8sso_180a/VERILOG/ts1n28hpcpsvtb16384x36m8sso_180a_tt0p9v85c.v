...
`ifdef UNIT_DELAY
parameter tSDQ = 2.5559;
parameter tSLPQ = 2.5559;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7401;
    specparam tCKH = 0.1067;
    specparam tCKL = 0.1287;
    specparam tCS = 0.1063;
    specparam tCH = 0.0779;
    specparam tWS = 0.0597;
    specparam tWH = 0.0804;
    specparam tAS = 0.0816;
    specparam tAH = 0.0819;
    specparam tDS = 0.0505;
    specparam tDH = 0.0811;
    specparam tCD = 0.7401;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.7401;
`else    
    specparam tHOLD = 0.4848;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.1457;
    specparam tSDWK2CLK = 10.1457;
    specparam tSD = 0.7401;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.2282;
    specparam tSDQ = 2.5559;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9585;
    specparam tSLPWK2CLK = 0.9585;
    specparam tSLP = 0.7401;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.2590;
    specparam tSLPQ = 2.5559;
