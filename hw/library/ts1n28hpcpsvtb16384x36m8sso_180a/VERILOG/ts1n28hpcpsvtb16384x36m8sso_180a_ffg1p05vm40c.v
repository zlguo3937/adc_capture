...
`ifdef UNIT_DELAY
parameter tSDQ = 2.8819;
parameter tSLPQ = 2.5757;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5302;
    specparam tCKH = 0.0772;
    specparam tCKL = 0.0917;
    specparam tCS = 0.0800;
    specparam tCH = 0.0604;
    specparam tWS = 0.0462;
    specparam tWH = 0.0625;
    specparam tAS = 0.0592;
    specparam tAH = 0.0637;
    specparam tDS = 0.0414;
    specparam tDH = 0.0629;
    specparam tCD = 0.5302;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5302;
`else    
    specparam tHOLD = 0.3334;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.3283;
    specparam tSDWK2CLK = 8.3283;
    specparam tSD = 0.5302;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.8420;
    specparam tSDQ = 2.8819;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.6908;
    specparam tSLPWK2CLK = 0.6908;
    specparam tSLP = 0.5302;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.8578;
    specparam tSLPQ = 2.5757;
