...
`ifdef UNIT_DELAY
parameter tSDQ = 2.1497;
parameter tSLPQ = 2.1497;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5930;
    specparam tCKH = 0.0830;
    specparam tCKL = 0.0957;
    specparam tCS = 0.0875;
    specparam tCH = 0.0649;
    specparam tWS = 0.0483;
    specparam tWH = 0.0671;
    specparam tAS = 0.0634;
    specparam tAH = 0.0685;
    specparam tDS = 0.0425;
    specparam tDH = 0.0676;
    specparam tCD = 0.5930;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5930;
`else    
    specparam tHOLD = 0.3610;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.2804;
    specparam tSDWK2CLK = 9.2804;
    specparam tSD = 0.5930;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.2930;
    specparam tSDQ = 2.1497;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8062;
    specparam tSLPWK2CLK = 0.8062;
    specparam tSLP = 0.5930;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.3141;
    specparam tSLPQ = 2.1497;
