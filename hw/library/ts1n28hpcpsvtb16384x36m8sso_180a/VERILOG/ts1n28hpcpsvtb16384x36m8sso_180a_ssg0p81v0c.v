...
`ifdef UNIT_DELAY
parameter tSDQ = 3.6704;
parameter tSLPQ = 3.6704;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.0409;
    specparam tCKH = 0.1490;
    specparam tCKL = 0.1907;
    specparam tCS = 0.1416;
    specparam tCH = 0.1009;
    specparam tWS = 0.0801;
    specparam tWH = 0.1037;
    specparam tAS = 0.1136;
    specparam tAH = 0.1054;
    specparam tDS = 0.0676;
    specparam tDH = 0.1059;
    specparam tCD = 1.0409;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.0409;
`else    
    specparam tHOLD = 0.7400;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.5909;
    specparam tSDWK2CLK = 11.5909;
    specparam tSD = 1.0409;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.2759;
    specparam tSDQ = 3.6704;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.3764;
    specparam tSLPWK2CLK = 1.3764;
    specparam tSLP = 1.0409;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3300;
    specparam tSLPQ = 3.6704;
