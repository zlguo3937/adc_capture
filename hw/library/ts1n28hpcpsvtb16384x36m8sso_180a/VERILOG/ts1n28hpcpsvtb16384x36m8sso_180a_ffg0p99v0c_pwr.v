...
`ifdef UNIT_DELAY
parameter tSDQ = 2.0190;
parameter tSLPQ = 2.0190;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5848;
    specparam tCKH = 0.0844;
    specparam tCKL = 0.1001;
    specparam tCS = 0.0863;
    specparam tCH = 0.0643;
    specparam tWS = 0.0492;
    specparam tWH = 0.0665;
    specparam tAS = 0.0642;
    specparam tAH = 0.0678;
    specparam tDS = 0.0432;
    specparam tDH = 0.0666;
    specparam tCD = 0.5848;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5848;
`else    
    specparam tHOLD = 0.3691;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.7240;
    specparam tSDWK2CLK = 8.7240;
    specparam tSD = 0.5848;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9838;
    specparam tSDQ = 2.0190;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7571;
    specparam tSLPWK2CLK = 0.7571;
    specparam tSLP = 0.5848;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.0019;
    specparam tSLPQ = 2.0190;
