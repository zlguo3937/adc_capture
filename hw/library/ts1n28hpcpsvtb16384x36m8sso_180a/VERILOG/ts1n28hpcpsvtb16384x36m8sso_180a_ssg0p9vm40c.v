...
module TS1N28HPCPSVTB16384X36M8SSO (
            SLP,
            SD,
            CLK, CEB, WEB,
            A, D,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPSVTB16384X36M8SSO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPSVTB16384X36M8SSO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 2.8599;
parameter tSLPQ = 2.8599;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8207;
    specparam tCKH = 0.1195;
    specparam tCKL = 0.1513;
    specparam tCS = 0.1151;
    specparam tCH = 0.0849;
    specparam tWS = 0.0670;
    specparam tWH = 0.0874;
    specparam tAS = 0.0919;
    specparam tAH = 0.0889;
    specparam tDS = 0.0575;
    specparam tDH = 0.0894;
    specparam tCD = 0.8207;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8207;
`else    
    specparam tHOLD = 0.5690;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.2436;
    specparam tSDWK2CLK = 10.2436;
    specparam tSD = 0.8207;
    specparam tXSD = 0.2835;
    specparam tSDX = 1.9882;
    specparam tSDQ = 2.8599;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0725;
    specparam tSLPWK2CLK = 1.0725;
    specparam tSLP = 0.8207;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.0333;
    specparam tSLPQ = 2.8599;
