...
`ifdef UNIT_DELAY
parameter tSDQ = 3.7475;
parameter tSLPQ = 3.7475;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.0624;
    specparam tCKH = 0.1521;
    specparam tCKL = 0.1965;
    specparam tCS = 0.1445;
    specparam tCH = 0.1024;
    specparam tWS = 0.0814;
    specparam tWH = 0.1052;
    specparam tAS = 0.1153;
    specparam tAH = 0.1069;
    specparam tDS = 0.0697;
    specparam tDH = 0.1074;
    specparam tCD = 1.0624;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.0624;
`else    
    specparam tHOLD = 0.7623;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.6729;
    specparam tSDWK2CLK = 11.6729;
    specparam tSD = 1.0624;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.2428;
    specparam tSDQ = 3.7475;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.4053;
    specparam tSLPWK2CLK = 1.4053;
    specparam tSLP = 1.0624;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3072;
    specparam tSLPQ = 3.7475;
