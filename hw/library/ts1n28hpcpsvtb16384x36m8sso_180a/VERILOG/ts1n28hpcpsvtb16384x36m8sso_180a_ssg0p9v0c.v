...
`ifdef UNIT_DELAY
parameter tSDQ = 2.8711;
parameter tSLPQ = 2.8711;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8236;
    specparam tCKH = 0.1200;
    specparam tCKL = 0.1501;
    specparam tCS = 0.1155;
    specparam tCH = 0.0849;
    specparam tWS = 0.0670;
    specparam tWH = 0.0875;
    specparam tAS = 0.0922;
    specparam tAH = 0.0890;
    specparam tDS = 0.0568;
    specparam tDH = 0.0895;
    specparam tCD = 0.8236;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8236;
`else    
    specparam tHOLD = 0.5671;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.2913;
    specparam tSDWK2CLK = 10.2913;
    specparam tSD = 0.8236;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.0681;
    specparam tSDQ = 2.8711;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0767;
    specparam tSLPWK2CLK = 1.0767;
    specparam tSLP = 0.8236;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.1146;
    specparam tSLPQ = 2.8711;
