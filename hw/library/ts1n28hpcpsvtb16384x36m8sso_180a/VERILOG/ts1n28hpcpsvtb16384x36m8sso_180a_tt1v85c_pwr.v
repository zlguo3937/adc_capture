...
`ifdef UNIT_DELAY
parameter tSDQ = 2.2795;
parameter tSLPQ = 2.2795;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6483;
    specparam tCKH = 0.0936;
    specparam tCKL = 0.1110;
    specparam tCS = 0.0949;
    specparam tCH = 0.0706;
    specparam tWS = 0.0540;
    specparam tWH = 0.0729;
    specparam tAS = 0.0723;
    specparam tAH = 0.0743;
    specparam tDS = 0.0462;
    specparam tDH = 0.0736;
    specparam tCD = 0.6483;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6483;
`else    
    specparam tHOLD = 0.4147;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.3858;
    specparam tSDWK2CLK = 9.3858;
    specparam tSD = 0.6483;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.1749;
    specparam tSDQ = 2.2795;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8548;
    specparam tSLPWK2CLK = 0.8548;
    specparam tSLP = 0.6483;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1982;
    specparam tSLPQ = 2.2795;
