...
`ifdef UNIT_DELAY
parameter tSDQ = 2.1861;
parameter tSLPQ = 2.1861;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6325;
    specparam tCKH = 0.0915;
    specparam tCKL = 0.1106;
    specparam tCS = 0.0927;
    specparam tCH = 0.0692;
    specparam tWS = 0.0535;
    specparam tWH = 0.0715;
    specparam tAS = 0.0708;
    specparam tAH = 0.0728;
    specparam tDS = 0.0457;
    specparam tDH = 0.0725;
    specparam tCD = 0.6325;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6325;
`else    
    specparam tHOLD = 0.4083;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.0056;
    specparam tSDWK2CLK = 9.0056;
    specparam tSD = 0.6325;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.0214;
    specparam tSDQ = 2.1861;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8198;
    specparam tSLPWK2CLK = 0.8198;
    specparam tSLP = 0.6325;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.0419;
    specparam tSLPQ = 2.1861;
