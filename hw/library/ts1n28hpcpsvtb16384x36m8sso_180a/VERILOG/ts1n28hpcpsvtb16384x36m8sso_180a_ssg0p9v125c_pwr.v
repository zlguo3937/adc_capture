...
`ifdef UNIT_DELAY
parameter tSDQ = 2.8697;
parameter tSLPQ = 2.8697;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8182;
    specparam tCKH = 0.1196;
    specparam tCKL = 0.1444;
    specparam tCS = 0.1165;
    specparam tCH = 0.0852;
    specparam tWS = 0.0661;
    specparam tWH = 0.0879;
    specparam tAS = 0.0919;
    specparam tAH = 0.0896;
    specparam tDS = 0.0554;
    specparam tDH = 0.0889;
    specparam tCD = 0.8182;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8182;
`else    
    specparam tHOLD = 0.5489;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.2034;
    specparam tSDWK2CLK = 11.2034;
    specparam tSD = 0.8182;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.3429;
    specparam tSDQ = 2.8697;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0761;
    specparam tSLPWK2CLK = 1.0761;
    specparam tSLP = 0.8182;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3774;
    specparam tSLPQ = 2.8697;
