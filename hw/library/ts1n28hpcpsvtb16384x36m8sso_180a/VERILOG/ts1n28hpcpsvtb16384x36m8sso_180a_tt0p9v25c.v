...
`ifdef UNIT_DELAY
parameter tSDQ = 2.5293;
parameter tSLPQ = 2.5293;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7375;
    specparam tCKH = 0.1065;
    specparam tCKL = 0.1306;
    specparam tCS = 0.1056;
    specparam tCH = 0.0774;
    specparam tWS = 0.0600;
    specparam tWH = 0.0798;
    specparam tAS = 0.0813;
    specparam tAH = 0.0813;
    specparam tDS = 0.0509;
    specparam tDH = 0.0808;
    specparam tCD = 0.7375;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.7375;
`else    
    specparam tHOLD = 0.4892;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.6494;
    specparam tSDWK2CLK = 9.6494;
    specparam tSD = 0.7375;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.0850;
    specparam tSDQ = 2.5293;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9485;
    specparam tSLPWK2CLK = 0.9485;
    specparam tSLP = 0.7375;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1109;
    specparam tSLPQ = 2.5293;
