...
`ifdef UNIT_DELAY
parameter tSDQ = 3.4228;
parameter tSLPQ = 3.4228;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9682;
    specparam tCKH = 0.1400;
    specparam tCKL = 0.1726;
    specparam tCS = 0.1349;
    specparam tCH = 0.0963;
    specparam tWS = 0.0755;
    specparam tWH = 0.0994;
    specparam tAS = 0.1078;
    specparam tAH = 0.1012;
    specparam tDS = 0.0631;
    specparam tDH = 0.1001;
    specparam tCD = 0.9682;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.9682;
`else    
    specparam tHOLD = 0.6686;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 12.3246;
    specparam tSDWK2CLK = 12.3246;
    specparam tSD = 0.9682;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.4533;
    specparam tSDQ = 3.4228;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2836;
    specparam tSLPWK2CLK = 1.2836;
    specparam tSLP = 0.9682;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.4945;
    specparam tSLPQ = 3.4228;
