...
`ifdef UNIT_DELAY
parameter tSDQ = 1.9109;
parameter tSLPQ = 1.9109;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5480;
    specparam tCKH = 0.0787;
    specparam tCKL = 0.0929;
    specparam tCS = 0.0817;
    specparam tCH = 0.0615;
    specparam tWS = 0.0468;
    specparam tWH = 0.0636;
    specparam tAS = 0.0604;
    specparam tAH = 0.0648;
    specparam tDS = 0.0414;
    specparam tDH = 0.0643;
    specparam tCD = 0.5480;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5480;
`else    
    specparam tHOLD = 0.3405;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.4935;
    specparam tSDWK2CLK = 8.4935;
    specparam tSD = 0.5480;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9708;
    specparam tSDQ = 1.9109;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7166;
    specparam tSLPWK2CLK = 0.7166;
    specparam tSLP = 0.5480;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.9844;
    specparam tSLPQ = 1.9109;
