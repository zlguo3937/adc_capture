...
`ifdef UNIT_DELAY
parameter tSDQ = 2.2360;
parameter tSLPQ = 2.2360;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6227;
    specparam tCKH = 0.0875;
    specparam tCKL = 0.1015;
    specparam tCS = 0.0912;
    specparam tCH = 0.0673;
    specparam tWS = 0.0502;
    specparam tWH = 0.0697;
    specparam tAS = 0.0667;
    specparam tAH = 0.0710;
    specparam tDS = 0.0439;
    specparam tDH = 0.0697;
    specparam tCD = 0.6227;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6227;
`else    
    specparam tHOLD = 0.3835;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.5222;
    specparam tSDWK2CLK = 9.5222;
    specparam tSD = 0.6227;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.3074;
    specparam tSDQ = 2.2360;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8385;
    specparam tSLPWK2CLK = 0.8385;
    specparam tSLP = 0.6227;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.3261;
    specparam tSLPQ = 2.2360;
