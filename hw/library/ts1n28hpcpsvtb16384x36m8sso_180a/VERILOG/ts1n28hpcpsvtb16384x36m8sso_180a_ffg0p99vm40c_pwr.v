...
`ifdef UNIT_DELAY
parameter tSDQ = 2.8334;
parameter tSLPQ = 2.4858;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5701;
    specparam tCKH = 0.0828;
    specparam tCKL = 0.0995;
    specparam tCS = 0.0848;
    specparam tCH = 0.0636;
    specparam tWS = 0.0486;
    specparam tWH = 0.0658;
    specparam tAS = 0.0631;
    specparam tAH = 0.0670;
    specparam tDS = 0.0430;
    specparam tDH = 0.0660;
    specparam tCD = 0.5701;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5701;
`else    
    specparam tHOLD = 0.3633;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.5676;
    specparam tSDWK2CLK = 8.5676;
    specparam tSD = 0.5701;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.8591;
    specparam tSDQ = 2.8334;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7366;
    specparam tSLPWK2CLK = 0.7366;
    specparam tSLP = 0.5701;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.8766;
    specparam tSLPQ = 2.4858;
