...
`ifdef UNIT_DELAY
parameter tSDQ = 3.7770;
parameter tSLPQ = 3.7770;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.0576;
    specparam tCKH = 0.1894;
    specparam tCKL = 0.2306;
    specparam tCS = 0.1771;
    specparam tCH = 0.1146;
    specparam tWS = 0.0974;
    specparam tWH = 0.1184;
    specparam tAS = 0.1393;
    specparam tAH = 0.1205;
    specparam tDS = 0.1019;
    specparam tDH = 0.1052;
    specparam tCD = 1.0484;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.0484;
`else    
    specparam tHOLD = 0.7277;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.9193;
    specparam tSDWK2CLK = 11.9193;
    specparam tSD = 1.0576;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.5088;
    specparam tSDQ = 3.7770;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.4164;
    specparam tSLPWK2CLK = 1.4164;
    specparam tSLP = 1.0576;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.5428;
    specparam tSLPQ = 3.7770;
