...
`ifdef UNIT_DELAY
parameter tSDQ = 5.6379;
parameter tSLPQ = 4.9706;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6652;
    specparam tCKH = 0.1151;
    specparam tCKL = 0.1375;
    specparam tCS = 0.1127;
    specparam tCH = 0.0792;
    specparam tWS = 0.0635;
    specparam tWH = 0.0819;
    specparam tAS = 0.0843;
    specparam tAH = 0.0834;
    specparam tDS = 0.0638;
    specparam tDH = 0.0714;
    specparam tCD = 0.6496;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6496;
`else    
    specparam tHOLD = 0.4158;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.5842;
    specparam tSDWK2CLK = 8.5842;
    specparam tSD = 0.6652;
    specparam tXSD = 0.1815;
    specparam tSDX = 1.9716;
    specparam tSDQ = 5.6379;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8909;
    specparam tSLPWK2CLK = 0.8909;
    specparam tSLP = 0.6652;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 1.9855;
    specparam tSLPQ = 4.9706;
