...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPHVTB32768X9M16SSO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPHVTB32768X9M16SSO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 4.6139;
parameter tSLPQ = 4.6139;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.2919;
    specparam tCKH = 0.2177;
    specparam tCKL = 0.2785;
    specparam tCS = 0.2095;
    specparam tCH = 0.1261;
    specparam tWS = 0.1137;
    specparam tWH = 0.1301;
    specparam tAS = 0.1644;
    specparam tAH = 0.1324;
    specparam tDS = 0.1267;
    specparam tDH = 0.1227;
    specparam tCD = 1.2155;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.2155;
`else    
    specparam tHOLD = 0.8931;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.7211;
    specparam tSDWK2CLK = 11.7211;
    specparam tSD = 1.2919;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.5498;
    specparam tSDQ = 4.6139;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.7302;
    specparam tSLPWK2CLK = 1.7302;
    specparam tSLP = 1.2919;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.5850;
    specparam tSLPQ = 4.6139;
