...
`ifdef UNIT_DELAY
parameter tSDQ = 2.1967;
parameter tSLPQ = 2.1967;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6151;
    specparam tCKH = 0.0998;
    specparam tCKL = 0.1140;
    specparam tCS = 0.1009;
    specparam tCH = 0.0718;
    specparam tWS = 0.0547;
    specparam tWH = 0.0744;
    specparam tAS = 0.0721;
    specparam tAH = 0.0758;
    specparam tDS = 0.0545;
    specparam tDH = 0.0619;
    specparam tCD = 0.5798;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5798;
`else    
    specparam tHOLD = 0.3443;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.5115;
    specparam tSDWK2CLK = 8.5115;
    specparam tSD = 0.6151;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.2197;
    specparam tSDQ = 2.1967;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8237;
    specparam tSLPWK2CLK = 0.8237;
    specparam tSLP = 0.6151;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.2348;
    specparam tSLPQ = 2.1967;
