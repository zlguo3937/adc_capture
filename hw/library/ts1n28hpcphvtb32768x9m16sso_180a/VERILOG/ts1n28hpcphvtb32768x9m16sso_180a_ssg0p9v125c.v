...
`ifdef UNIT_DELAY
parameter tSDQ = 3.0979;
parameter tSLPQ = 3.0979;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8674;
    specparam tCKH = 0.1531;
    specparam tCKL = 0.1855;
    specparam tCS = 0.1454;
    specparam tCH = 0.0988;
    specparam tWS = 0.0814;
    specparam tWH = 0.1021;
    specparam tAS = 0.1130;
    specparam tAH = 0.1038;
    specparam tDS = 0.0830;
    specparam tDH = 0.0893;
    specparam tCD = 0.8551;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8551;
`else    
    specparam tHOLD = 0.5725;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 10.5575;
    specparam tSDWK2CLK = 10.5575;
    specparam tSD = 0.8674;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.3230;
    specparam tSDQ = 3.0979;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.1617;
    specparam tSLPWK2CLK = 1.1617;
    specparam tSLP = 0.8674;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.3487;
    specparam tSLPQ = 3.0979;
