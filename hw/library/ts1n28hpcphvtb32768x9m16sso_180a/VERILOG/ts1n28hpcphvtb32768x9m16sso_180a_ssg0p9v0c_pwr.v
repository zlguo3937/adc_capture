...
`ifdef UNIT_DELAY
parameter tSDQ = 3.1909;
parameter tSLPQ = 3.1909;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.8935;
    specparam tCKH = 0.1592;
    specparam tCKL = 0.1970;
    specparam tCS = 0.1507;
    specparam tCH = 0.0996;
    specparam tWS = 0.0856;
    specparam tWH = 0.1029;
    specparam tAS = 0.1183;
    specparam tAH = 0.1047;
    specparam tDS = 0.0886;
    specparam tDH = 0.0951;
    specparam tCD = 0.8862;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8862;
`else    
    specparam tHOLD = 0.6154;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.8496;
    specparam tSDWK2CLK = 9.8496;
    specparam tSD = 0.8935;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.1268;
    specparam tSDQ = 3.1909;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.1966;
    specparam tSLPWK2CLK = 1.1966;
    specparam tSLP = 0.8935;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.1588;
    specparam tSLPQ = 3.1909;
