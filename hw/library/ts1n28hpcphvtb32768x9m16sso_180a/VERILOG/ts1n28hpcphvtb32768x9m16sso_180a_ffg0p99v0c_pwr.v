...
`ifdef UNIT_DELAY
parameter tSDQ = 5.7240;
parameter tSLPQ = 4.9103;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6155;
    specparam tCKH = 0.1052;
    specparam tCKL = 0.1245;
    specparam tCS = 0.1049;
    specparam tCH = 0.0734;
    specparam tWS = 0.0579;
    specparam tWH = 0.0759;
    specparam tAS = 0.0759;
    specparam tAH = 0.0773;
    specparam tDS = 0.0586;
    specparam tDH = 0.0657;
    specparam tCD = 0.5989;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5989;
`else    
    specparam tHOLD = 0.3744;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.1720;
    specparam tSDWK2CLK = 8.1720;
    specparam tSD = 0.6155;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9326;
    specparam tSDQ = 5.7240;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8243;
    specparam tSLPWK2CLK = 0.8243;
    specparam tSLP = 0.6155;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.9377;
    specparam tSLPQ = 4.9103;
