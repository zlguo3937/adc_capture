...
`ifdef UNIT_DELAY
parameter tSDQ = 4.8073;
parameter tSLPQ = 4.2155;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7905;
    specparam tCKH = 0.1392;
    specparam tCKL = 0.1682;
    specparam tCS = 0.1340;
    specparam tCH = 0.0900;
    specparam tWS = 0.0743;
    specparam tWH = 0.0931;
    specparam tAS = 0.1012;
    specparam tAH = 0.0948;
    specparam tDS = 0.0750;
    specparam tDH = 0.0830;
    specparam tCD = 0.7819;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.7819;
`else    
    specparam tHOLD = 0.5190;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.3417;
    specparam tSDWK2CLK = 9.3417;
    specparam tSD = 0.7905;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.0823;
    specparam tSDQ = 4.8073;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0587;
    specparam tSLPWK2CLK = 1.0587;
    specparam tSLP = 0.7905;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1011;
    specparam tSLPQ = 4.2155;
