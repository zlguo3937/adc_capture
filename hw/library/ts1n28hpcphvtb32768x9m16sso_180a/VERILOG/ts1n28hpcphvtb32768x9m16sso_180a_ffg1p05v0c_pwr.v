...
`ifdef UNIT_DELAY
parameter tSDQ = 5.9744;
parameter tSLPQ = 5.4559;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5707;
    specparam tCKH = 0.0973;
    specparam tCKL = 0.1135;
    specparam tCS = 0.0977;
    specparam tCH = 0.0693;
    specparam tWS = 0.0543;
    specparam tWH = 0.0717;
    specparam tAS = 0.0702;
    specparam tAH = 0.0731;
    specparam tDS = 0.0547;
    specparam tDH = 0.0617;
    specparam tCD = 0.5518;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5518;
`else    
    specparam tHOLD = 0.3395;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 7.9233;
    specparam tSDWK2CLK = 7.9233;
    specparam tSD = 0.5707;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.9093;
    specparam tSDQ = 5.9744;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7643;
    specparam tSLPWK2CLK = 0.7643;
    specparam tSLP = 0.5707;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.9171;
    specparam tSLPQ = 5.4559;
