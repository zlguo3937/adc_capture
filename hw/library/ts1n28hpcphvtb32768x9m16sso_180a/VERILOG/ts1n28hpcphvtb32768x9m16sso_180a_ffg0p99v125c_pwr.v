...
`ifdef UNIT_DELAY
parameter tSDQ = 2.3143;
parameter tSLPQ = 2.3143;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6480;
    specparam tCKH = 0.1066;
    specparam tCKL = 0.1229;
    specparam tCS = 0.1065;
    specparam tCH = 0.0751;
    specparam tWS = 0.0577;
    specparam tWH = 0.0777;
    specparam tAS = 0.0766;
    specparam tAH = 0.0792;
    specparam tDS = 0.0574;
    specparam tDH = 0.0651;
    specparam tCD = 0.6168;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6168;
`else    
    specparam tHOLD = 0.3725;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.7480;
    specparam tSDWK2CLK = 8.7480;
    specparam tSD = 0.6480;
    specparam tXSD = 0.1275;
    specparam tSDX = 2.2332;
    specparam tSDQ = 2.3143;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8679;
    specparam tSLPWK2CLK = 0.8679;
    specparam tSLP = 0.6480;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 2.2479;
    specparam tSLPQ = 2.3143;
