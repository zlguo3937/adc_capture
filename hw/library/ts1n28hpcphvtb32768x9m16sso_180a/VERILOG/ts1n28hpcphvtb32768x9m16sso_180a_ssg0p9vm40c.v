...
`ifdef UNIT_DELAY
parameter tSDQ = 3.2203;
parameter tSLPQ = 3.2203;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.9017;
    specparam tCKH = 0.1597;
    specparam tCKL = 0.1998;
    specparam tCS = 0.1517;
    specparam tCH = 0.0996;
    specparam tWS = 0.0864;
    specparam tWH = 0.1028;
    specparam tAS = 0.1195;
    specparam tAH = 0.1046;
    specparam tDS = 0.0906;
    specparam tDH = 0.0962;
    specparam tCD = 0.8920;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.8920;
`else    
    specparam tHOLD = 0.6243;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.8440;
    specparam tSDWK2CLK = 9.8440;
    specparam tSD = 0.9017;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.0726;
    specparam tSDQ = 3.2203;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.2076;
    specparam tSLPWK2CLK = 1.2076;
    specparam tSLP = 0.9017;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.1059;
    specparam tSLPQ = 3.2203;
