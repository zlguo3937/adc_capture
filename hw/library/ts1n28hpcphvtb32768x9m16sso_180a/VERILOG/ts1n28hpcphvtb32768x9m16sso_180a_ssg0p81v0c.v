...
`ifdef UNIT_DELAY
parameter tSDQ = 4.3638;
parameter tSLPQ = 4.3638;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 1.2219;
    specparam tCKH = 0.2102;
    specparam tCKL = 0.2657;
    specparam tCS = 0.1996;
    specparam tCH = 0.1232;
    specparam tWS = 0.1093;
    specparam tWH = 0.1271;
    specparam tAS = 0.1574;
    specparam tAH = 0.1293;
    specparam tDS = 0.1194;
    specparam tDH = 0.1182;
    specparam tCD = 1.1743;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 1.1743;
`else    
    specparam tHOLD = 0.8486;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 11.5109;
    specparam tSDWK2CLK = 11.5109;
    specparam tSD = 1.2219;
    specparam tXSD = 0.2835;
    specparam tSDX = 2.5028;
    specparam tSDQ = 4.3638;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.6364;
    specparam tSLPWK2CLK = 1.6364;
    specparam tSLP = 1.2219;
    specparam tXSLP = 0.2835;
    specparam tSLPX = 2.5505;
    specparam tSLPQ = 4.3638;
