...
`ifdef UNIT_DELAY
parameter tSDQ = 6.6395;
parameter tSLPQ = 5.2746;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.5572;
    specparam tCKH = 0.0950;
    specparam tCKL = 0.1125;
    specparam tCS = 0.0961;
    specparam tCH = 0.0684;
    specparam tWS = 0.0539;
    specparam tWH = 0.0707;
    specparam tAS = 0.0694;
    specparam tAH = 0.0720;
    specparam tDS = 0.0545;
    specparam tDH = 0.0615;
    specparam tCD = 0.5387;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5387;
`else    
    specparam tHOLD = 0.3348;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 7.8083;
    specparam tSDWK2CLK = 7.8083;
    specparam tSD = 0.5572;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.7931;
    specparam tSDQ = 6.6395;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.7462;
    specparam tSLPWK2CLK = 0.7462;
    specparam tSLP = 0.5572;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.7984;
    specparam tSLPQ = 5.2746;
