...
`ifdef UNIT_DELAY
parameter tSDQ = 6.3327;
parameter tSLPQ = 5.1301;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6045;
    specparam tCKH = 0.1043;
    specparam tCKL = 0.1242;
    specparam tCS = 0.1041;
    specparam tCH = 0.0726;
    specparam tWS = 0.0577;
    specparam tWH = 0.0750;
    specparam tAS = 0.0754;
    specparam tAH = 0.0764;
    specparam tDS = 0.0583;
    specparam tDH = 0.0659;
    specparam tCD = 0.5896;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.5896;
`else    
    specparam tHOLD = 0.3727;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 8.0621;
    specparam tSDWK2CLK = 8.0621;
    specparam tSD = 0.6045;
    specparam tXSD = 0.1275;
    specparam tSDX = 1.8169;
    specparam tSDQ = 6.3327;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.8096;
    specparam tSLPWK2CLK = 0.8096;
    specparam tSLP = 0.6045;
    specparam tXSLP = 0.1275;
    specparam tSLPX = 1.8303;
    specparam tSLPQ = 5.1301;
