...
`ifdef UNIT_DELAY
parameter tSDQ = 2.8041;
parameter tSLPQ = 2.8041;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.7851;
    specparam tCKH = 0.1375;
    specparam tCKL = 0.1643;
    specparam tCS = 0.1326;
    specparam tCH = 0.0900;
    specparam tWS = 0.0727;
    specparam tWH = 0.0930;
    specparam tAS = 0.0997;
    specparam tAH = 0.0947;
    specparam tDS = 0.0730;
    specparam tDH = 0.0809;
    specparam tCD = 0.7718;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.7718;
`else    
    specparam tHOLD = 0.5030;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.8012;
    specparam tSDWK2CLK = 9.8012;
    specparam tSD = 0.7851;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.1955;
    specparam tSDQ = 2.8041;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 1.0515;
    specparam tSLPWK2CLK = 1.0515;
    specparam tSLP = 0.7851;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.2154;
    specparam tSLPQ = 2.8041;
