...
`ifdef UNIT_DELAY
parameter tSDQ = 4.8284;
parameter tSLPQ = 4.2342;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.6793;
    specparam tCKH = 0.1161;
    specparam tCKL = 0.1371;
    specparam tCS = 0.1139;
    specparam tCH = 0.0800;
    specparam tWS = 0.0634;
    specparam tWH = 0.0828;
    specparam tAS = 0.0848;
    specparam tAH = 0.0844;
    specparam tDS = 0.0637;
    specparam tDH = 0.0707;
    specparam tCD = 0.6561;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.6561;
`else    
    specparam tHOLD = 0.4132;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 9.0573;
    specparam tSDWK2CLK = 9.0573;
    specparam tSD = 0.6793;
    specparam tXSD = 0.1815;
    specparam tSDX = 2.1176;
    specparam tSDQ = 4.8284;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.9097;
    specparam tSLPWK2CLK = 0.9097;
    specparam tSLP = 0.6793;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 2.1256;
    specparam tSLPQ = 4.2342;
