...
new_project ${TOP_MODULE}_sg_lint -force
...
#}
current_goal Group_Run -goal {lint/lint_rtl lint/lint_rtl_enhanced lint/lint_turbo_rtl lint/lint_functional_rtl lint/lint_abstract adv_lint/adv_lint_struct adv_lint/adv_lint_verify}
...
# 10.analyze results
set LINT_PATH ${REPORT_PATH}/lint
...
set sg_log              $WORK_PATH/work/${TOP_MODULE}_sg_lint/${TOP_MODULE}/Group_Run/spyglass.log
...
save_project  -force ${TOP_MODULE}_sg_lint.prj
close_project -force

puts "\n---------------------------------------------------------------------------------------------------"
puts " Please select the one of following command to open SG_Lint project:\n"
puts " 1:"
puts " spyglass -project ${TOP_MODULE}_sg_lint.prj &\n"
puts " 2:"
puts " make lint_gui\n"
