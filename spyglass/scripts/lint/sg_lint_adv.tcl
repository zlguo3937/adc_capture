...
new_project ${TOP_MODULE}_sg_lint_adv -force
...
#}
current_goal Group_Run -goal {adv_lint/adv_lint_struct adv_lint/adv_lint_verify}
...
# 10.analyze results
set LINT_PATH ${REPORT_PATH}/lint/lint_adv
...
set sg_log              $WORK_PATH/work/${TOP_MODULE}_sg_lint_adv/${TOP_MODULE}/Group_Run/spyglass.log
...
save_project  -force ${TOP_MODULE}_sg_lint_adv.prj
close_project -force

puts "\n---------------------------------------------------------------------------------------------------"
puts " Please select the one of following command to open SG_Lint project:\n"
puts " 1:"
puts " spyglass -project ${TOP_MODULE}_sg_lint_adv.prj &\n"
puts " 2:"
puts " make lint_gui\n"
