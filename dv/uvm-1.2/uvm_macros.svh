...
// Modified by Verdi
`ifndef UVM_VERDI_PORT_RECORDING
`define UVM_VERDI_NO_PORT_RECORDING
`endif

`ifdef UVM_NO_VERDI_RECORD
`define UVM_VERDI_NO_VERDI_TRACE
`define UVM_VERDI_NO_HIER_TRACE
`define UVM_VERDI_NO_COMP_TYPE
`define UVM_VERDI_NO_FACTORY_RECORDING
`define UVM_VERDI_NO_PORT_RECORDING
`define UVM_VERDI_NO_REG_RECORDING
`define UVM_VERDI_NO_IMPLICIT_GET
`endif
// End

`include "macros/uvm_version_defines.svh"
`include "macros/uvm_global_defines.svh"
`include "macros/snps_macros.svp"
