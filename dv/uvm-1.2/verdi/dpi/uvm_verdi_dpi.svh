...
`ifdef VERDI_MSG_PARSE_DPI
   ...
   import "DPI-C" context function int parse_phase_msg_by_chandle(input string message, output chandle domain, output chandle schedule, output chandle phase); 
`endif

   import "DPI-C" context function int find_substr_by_C(input string org_str, input string search_str); 
   import "DPI-C" context function string verdi_dump_resource_value(input string rsrc, output chandle rtn_str_ptr);
   ...
   import "DPI-C" context function string verdi_dpi_get_c_string_by_chandle(input chandle c_str_ptr);
   import "DPI-C" context function void verdi_dpi_free_c_string_by_chandle(input chandle c_str_ptr);
   import "DPI-C" context function void verdi_dhier_interface_by_comp_hier(input string var_name);
   import "DPI-C" context function void verdi_dhier_interface_by_classdefn(input string var_name);
...
`else
   ...
   function string verdi_dump_resource_value(input string rsrc, output chandle rtn_str_ptr);
      if(is_error_printed) 
         return "";
      is_error_printed = 1; 
      uvm_report_info("UVM_VERDI_DPI",
   ...
   function string verdi_upper_scope(input string inst_scope_name, output chandle upper_scope_pointer);
      if(is_error_printed) 
         return "";
      is_error_printed = 1; 
      uvm_report_info("UVM_VERDI_DPI",
   ...
   function string verdi_dpi_get_c_string_by_chandle(input chandle c_str_ptr);
      if(is_error_printed) 
         return "";
      is_error_printed = 1; 
      uvm_report_info("UVM_VERDI_DPI",
   ...
   function void verdi_dpi_free_c_string_by_chandle(input chandle c_str_ptr);
      if(is_error_printed) 
         return;
      is_error_printed = 1; 
      uvm_report_info("UVM_VERDI_DPI",
   ...
   function void verdi_dhier_interface_by_comp_hier(input string var_name);
      if(is_error_printed) 
         return;
      is_error_printed = 1; 
      uvm_report_info("UVM_VERDI_DPI",
   ...
   function void verdi_dhier_interface_by_classdefn(input string var_name);
      if(is_error_printed) 
         return;
      is_error_printed = 1; 
      uvm_report_info("UVM_VERDI_DPI",
...
*/
   ...
   function int parse_phase_msg_by_chandle(input string message, output chandle domain, output chandle schedule, output chandle phase);
      if(is_error_printed)
         return 0;
      is_error_printed = 1;
      uvm_report_info("UVM_VERDI_DPI",
...
`ifdef XVM // Verdi P10049895-123644
      automatic int endedId=0; 
`endif
...
`endif
   ...
   function automatic void verdi_dump_vif_name(string component_name, input int streamId);
      ...
      do begin
         ...
         do begin
            ...
            verdi_dpi_free_c_string_by_chandle(ptr);
   ...
   function string verdi_dump_rsrc_obj(string scope_name, string field_name);
      ...
      if((cp!=null) && cp.rtab.exists(field_name)) begin
         ...
         if(verdi_object_if_recording!=null) begin
            chandle ptr;
            rsrc_name = verdi_dump_resource_value("verdi_object_if_recording", ptr);
            verdi_dpi_free_c_string_by_chandle(ptr);
         end
      end
      return rsrc_name; 
