...
class uvm_verdi_recorder extends uvm_recorder;
   ...
   function void process_desc(string desc,int txh);
      ...
      string left_string_three, right_string_three;
      string left_string_four, right_string_four;
      string object_id_str, sequencer_id_str, object_type_str, sequencer_type_str;
      string numbits_name;
      longint unsigned pli_handle=0;

      if (desc=="")
          return;
      pli_handle = uvmPliHandleMap[txh];
// 6000025017
...
// 6000025017
`ifdef VERDI_REPLACE_DPI_WITH_PLI
          pli_inst.add_attribute_string(pli_handle, object_type_str, "+name+snps_object_id", "+numbit+0");
`else
          pli_inst.add_attribute_string(pli_handle, object_type_str, "snps_object_id", "");
`endif
//
...
// 6000025017
`ifdef VERDI_REPLACE_DPI_WITH_PLI
          pli_inst.add_attribute_string_hidden(pli_handle, sequencer_type_str, "+name+sequencer_type");
`else
          pli_inst.add_attribute_string_hidden(pli_handle, sequencer_type_str, "sequencer_type");
`endif
//
          if (is_verdi_debug_enabled()) begin
...
// 6000025017
`ifdef VERDI_REPLACE_DPI_WITH_PLI
          pli_inst.add_attribute_string_hidden(pli_handle, right_string_three, "+name+starting_phase");
`else
          pli_inst.add_attribute_string_hidden(pli_handle, right_string_three, "starting_phase");
`endif
//
          if (is_verdi_debug_enabled()) begin
...
// 6000025017
`ifdef VERDI_REPLACE_DPI_WITH_PLI
              pli_inst.add_attribute_string_hidden(pli_handle, right_string_three, "+name+parent_sequence");
`else
              pli_inst.add_attribute_string_hidden(pli_handle, right_string_three, "parent_sequence");
`endif
//
              if (is_verdi_debug_enabled()) begin
...
// 6000025017 
`ifdef VERDI_REPLACE_DPI_WITH_PLI
          pli_inst.add_attribute_string_hidden(pli_handle, right_string_four, "+name+parent_sequence");
`else
          pli_inst.add_attribute_string_hidden(pli_handle, right_string_four, "parent_sequence");
`endif
//
          if (is_verdi_debug_enabled()) begin
...
//
   ...
   protected virtual function void do_open(uvm_tr_stream stream,
                                             time open_time,
                                             string type_name);
      longint unsigned handle = 0, stream_id=0;
      string event_label;
   ...
   protected virtual function void do_record_object(string name,
      ...
      int            v;
      string         str;
      string         id_str, id_attr_name;
      
      if(identifier) begin 
         if(value != null) begin
            $swrite(str, "%0d", value.get_inst_id());
            $swrite(id_str, "%0s (@%0d)", $vcs_get_object_id(value), value.get_inst_id());
...
`endif 
         ...
         id_attr_name = {scope.get(), ".snps_object_id"};
         write_attribute_int(id_attr_name, uvm_string_to_bits(id_str),
                     UVM_STRING, 8*id_str.len());
      end
   ...
   protected virtual function void do_record_string(string name,
                                                    string value);
      longint pliHandle = 0;
      string val_name="",attr_name="",numbits_name="";
...
`endif
//
          pli_inst.add_attribute_severity_type(txh, severity_type, attr_name);
...
`endif
//
          pli_inst.add_attribute_verbosity_type(txh, verbosity_type, attr_name);
      end
  endfunction
   ...
   // numbits - number of valid bits
    function void write_attribute_int(string  nm,
      ...
      string attr_name="",numbits_name="",val_name="",tmp_nm=""; 
      longint pliHandle = 0; 
`ifdef VERDI_RECORD_RELATION
...
static function void link_tr_by_id(integer instId1, integer instId2, string relation);
   longint pliHandle1 = 0, pliHandle2 = 0; 
