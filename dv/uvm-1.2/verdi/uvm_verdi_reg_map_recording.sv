...
class uvm_map_access_recorder;
   ...
   extern virtual function bit  end_recording(string event_type, string path_s, string value_s, string reg_name, string map_s, string door_s); //9001494539
endclass
...
function bit uvm_map_access_recorder::end_recording(string event_type, string path_s, string value_s, string reg_name,string map_s,string door_s); // 9001494539
...
// P80000979-140209
    void'($sscanf(nvalue_s, "%h", value_logic));
//
...
`ifdef VERDI_REPLACE_DPI_WITH_PLI
    ...
    pli_inst.add_attribute_string(_cur_tr_h, map_s, "+name+map", "+numbit+0"); // 9001494539
    pli_inst.add_attribute_string(_cur_tr_h, door_s, "+name+door", "+numbit+0"); // 9001494539 
`else
    ...
    pli_inst.add_attribute_string(_cur_tr_h, map_s, "map", ""); // 9001494539
    pli_inst.add_attribute_string(_cur_tr_h, door_s, "door", ""); // 9001494539
`endif
//
